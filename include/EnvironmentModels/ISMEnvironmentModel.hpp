...
namespace BRTEnvironmentModel {
	...
	class CISMEnvironmentModel : public CEnviromentModelBase {
		...
		public:
			...
			/**
			 * @brief Get the number of image sources generated by this processor
			...
			/**
			 * @brief Get the number of visible image sources generated by this processor
			 * @return number of visible image sources
			 */
	...
	public:
		...
		*/
		...
		/**
		 * @brief Get the number of visible virtual sources generated by this environment model
		 * @return number of visible virtual sources
		 */ 
		size_t GetNumberOfActiveVirtualSources() override {
			std::lock_guard<std::mutex> l(mutex);
			size_t numberOrVisibleVirtualSources = 0;
			for (auto& it : sourcesConnectedProcessors) {
				numberOrVisibleVirtualSources += it.GetNumberOfVisibleImageSources();
			}
			return numberOrVisibleVirtualSources;
		}
