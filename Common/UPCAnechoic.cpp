...
namespace Common {
	...
	/////////////////////////////
	//CUPCAnechoic::CUPCAnechoic() : setupDone {false}, inputSize{0}, impulseResponseMemory{0}, impulseResponseNumberOfSubfilters{0}, impulseResponse_Frequency_Block_Size{0}
	//{				
	//}
	...
	//void CUPCAnechoic::ProcessUPConvolution(const CMonoBuffer<float>& inBuffer_Time, const std::vector<CMonoBuffer<float>>& IR, CMonoBuffer<float>& outBuffer)
	//{
	...
	//void CUPCAnechoic::ProcessUPConvolutionWithMemory(const CMonoBuffer<float>& inBuffer_Time, const std::vector<CMonoBuffer<float>>& IR, CMonoBuffer<float>& outBuffer)
	//{
	//	CMonoBuffer<float> sum;
	//	sum.resize(impulseResponse_Frequency_Block_Size, 0.0f);
	//	CMonoBuffer<float> temp;
